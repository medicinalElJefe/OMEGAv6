...
export const R314_BUILD_STAGES:readonly R314BuildStage[]=[
 ...
 {id:'R314-B04',order:4,title:'675-row Implementation Canon reconciliation',objective:'Compile every Implementation Canon V2 row to CURRENT, SUPERSEDED, DONOR, PLANNED, GATED or ABSENT using exact source/test evidence.',dependsOn:['R314-B02'],sourceFamilies:['AG-021'],deliverables:['675-row compiler','module/symbol/shader/API/DB/test/build-gate crosswalk','single-writer reconciliation','machine-readable completion ledger'],proof:['675 input rows classified','ACTIVE requires exact source evidence','no PLANNED row promoted by naming alone'],automationClass:'DATA_COMPILER',mutationClass:'DATA_ONLY'},
