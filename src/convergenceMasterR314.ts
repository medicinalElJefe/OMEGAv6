...
export const R314_BUILD_STAGES:readonly R314BuildStage[]=[
 ...
 {id:'R314-B18',order:18,title:'Full-system acceptance and continuous advancement',objective:'Require the complete dependency graph, monotonic predecessor capability floor, exact-head test matrix, production deployment receipt and residual reduction before a release or autonomous next cycle is accepted.',dependsOn:['R314-B03','R314-B04','R314-B06','R314-B07','R314-B08','R314-B09','R314-B10','R314-B11','R314-B12','R314-B13','R314-B14','R314-B15','R314-B16','R314-B17'],sourceFamilies:['R125','R141','R146','R147','R170','R210','R223','R241'],deliverables:['exact-head acceptance matrix','monotonic predecessor capability floor','production receipt','residual delta receipt','rollback target','next-cycle work queue'],proof:['all required workflows green on exact head','no predecessor route/capability/proof coverage loss','production source/version/assets match','live verification returned','measurable residual reduction','no unproven Canon admission'],automationClass:'ACCEPTANCE',mutationClass:'NONE'}
] as const;
