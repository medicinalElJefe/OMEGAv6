...
const SURFACES=[
 ['STUDIO','01','Command Center'],['STUDIO','02','Hybrid Link'],['STUDIO','03','Workspace'],['STUDIO','04','Cockpit'],['STUDIO','05','Immersive Traversal'],['STUDIO','06','Matter Traversal'],['STUDIO','07','Extreme Traversal'],['STUDIO','08','Visual Instrument'],['STUDIO','09','Relativity'],['STUDIO','10','Earth Now'],['STUDIO','11','Forecast'],['STUDIO','12','Atlas'],['STUDIO','13','Traversal'],['STUDIO','14','Create'],['OPERATIONS','15','Field'],['OPERATIONS','16','Data Motion'],['OPERATIONS','17','Reality Lab'],['OPERATIONS','18','Atlas Calculator'],['OPERATIONS','19','Infinity'],['OPERATIONS','20','Convergence'],['OPERATIONS','21','Quality Compiler'],['OPERATIONS','22','Build Out'],['WORK','23','Projects'],['WORK','24','Render Queue'],['WORK','25','Assets'],['INTELLIGENCE','26','Modes'],['INTELLIGENCE','27','Kernel Intelligence'],['INTELLIGENCE','28','Evidence & Proof'],['INTELLIGENCE','29','Memory'],['INTELLIGENCE','30','Archive Census'],['INTELLIGENCE','31','Archive Operators'],['INTELLIGENCE','32','Development'],['INTELLIGENCE','33','Canon Evolution'],['INTELLIGENCE','34','SAI Lab'],['GOVERNANCE','35','Governance'],['GOVERNANCE','36','Consolidation'],['GOVERNANCE','37','Instructions'],['SYSTEM','38','Plugins'],['SYSTEM','39','Settings'],['SYSTEM','40','System'],['SYSTEM','41','Validation'],['SYSTEM','42','System Atlas'],['SYSTEM','43','Scale Compiler'],['SYSTEM','44','Control Matrix']
] as const;
const DOMAIN_ROUTES:Record<DomainId,readonly string[]>={
 COMMAND:['Command Center','Hybrid Link','Workspace','Cockpit','Create'],
 VISUALIZE:['Immersive Traversal','Matter Traversal','Extreme Traversal','Visual Instrument','Relativity','Atlas','Traversal','Field','Data Motion','Atlas Calculator','Infinity','Convergence','Scale Compiler'],
 EARTH:['Earth Now','Forecast','Reality Lab'],
 INTELLIGENCE:['Modes','Kernel Intelligence','Memory','Canon Evolution','SAI Lab'],
 BUILD:['Build Out','Projects','Render Queue','Assets','Development','Consolidation'],
...
const DOMAINS:readonly Domain[]=[
 {id:'COMMAND',label:'Command',description:'Ask · operate · coordinate',routes:DOMAIN_ROUTES.COMMAND},
 {id:'VISUALIZE',label:'Visualize',description:'Fields · traversal · relativity',routes:DOMAIN_ROUTES.VISUALIZE},
 {id:'EARTH',label:'Earth',description:'Evidence · now · forecast',routes:DOMAIN_ROUTES.EARTH},
 {id:'INTELLIGENCE',label:'Intelligence',description:'Modes · SAI · memory',routes:DOMAIN_ROUTES.INTELLIGENCE},
 {id:'BUILD',label:'Build',description:'Projects · assets · production',routes:DOMAIN_ROUTES.BUILD},
 {id:'EVIDENCE',label:'Evidence',description:'Proof · archive · governance',routes:DOMAIN_ROUTES.EVIDENCE},
 {id:'SYSTEM',label:'System',description:'Runtime · controls · configuration',routes:DOMAIN_ROUTES.SYSTEM}
] as const;
