...
export const R291_PUBLIC_PROVENANCE_BOUNDARY='PUBLIC_CLIENT_USES_OPAQUE_PROVENANCE_KEYS_CONNECTED_STORAGE_LOCATORS_EXTERNAL' as const;
...
export type R290RecoveryBinding={
 ...
 driveArtifacts:{title:string;key:string;kind:'FILE'|'FOLDER'|'LEDGER'}[];
 masterMenuId:string;
 masterMenu:string;
 routes:string[];
 successor:string;
...
export const R290_DEEP_RECOVERY_BINDINGS:R290RecoveryBinding[]=[
 {
  ...
  driveArtifacts:[
   {title:'atlas_camera_prototype_webgl.html',key:'PROV-R290-01-A',kind:'FILE'},
   {title:'v31r1__INTEGRATION_REPORT.txt',key:'PROV-R290-01-B',kind:'FILE'},
   {title:'v31r1__CONTROL_SURFACE_REPORT.txt',key:'PROV-R290-01-C',kind:'FILE'}
  ],
 ...
 },
 {
  ...
  driveArtifacts:[
   {title:'v31r1__UNIFIED_LANGUAGE_REPORT.txt',key:'PROV-R290-02-A',kind:'FILE'},
   {title:'v24__UNIFIED_LANGUAGE_REPORT.txt',key:'PROV-R290-02-B',kind:'FILE'},
   {title:'OMEGA_ALL_SOFTWARE_61917364224D_FULL_BUILD_v22.xlsx',key:'PROV-R290-02-C',kind:'LEDGER'}
  ],
 ...
 },
 {
  ...
  driveArtifacts:[
   {title:'omega_life_engine.xlsx',key:'PROV-R290-03-A',kind:'FILE'},
   {title:'omega_total_engine.xlsx',key:'PROV-R290-03-B',kind:'FILE'},
   {title:'Omega_Kernel_Integrated_20736D_PATCHED.xlsx',key:'PROV-R290-03-C',kind:'FILE'}
  ],
 ...
 },
 {
  ...
  driveArtifacts:[
   {title:'renderer_20736_color_state.html',key:'PROV-R290-04-A',kind:'FILE'},
   {title:'DIMREL_NATIVE_RENDERER_1728_MASTER_PLAN.md',key:'PROV-R290-04-B',kind:'FILE'}
  ],
 ...
 },
 {
  ...
  driveArtifacts:[
   {title:'OMEGA_ENTIRE_BUILD_61917364224D_FULL_CHART_v20.xlsx',key:'PROV-R290-05-A',kind:'LEDGER'},
   {title:'OMEGA_ALL_SOFTWARE_61917364224D_FULL_BUILD_v22.xlsx',key:'PROV-R290-05-B',kind:'LEDGER'},
   {title:'final_12_to_1_merge_workbook.xlsx',key:'PROV-R290-05-C',kind:'LEDGER'}
  ],
 ...
 },
 {
  ...
  driveArtifacts:[
   {title:'OMEGA_ONE_SYSTEM_J_DRIVE_1728D_AUTOPING_LEDGER.xlsx',key:'PROV-R290-06-A',kind:'LEDGER'},
   {title:'OMEGA_ONE_SYSTEM_FULL_SOFTWARE_MENU_LEDGER.xlsx',key:'PROV-R290-06-B',kind:'LEDGER'},
   {title:'OMEGA_20736D_IMPLEMENTATION_CANON_INDEX.xlsx',key:'PROV-R290-06-C',kind:'LEDGER'}
  ],
 ...
 },
 {
  ...
  driveArtifacts:[
   {title:'omega_cube_engine_v9.xlsx',key:'PROV-R290-07-A',kind:'FILE'},
   {title:'SpatialAudio',key:'PROV-R290-07-B',kind:'FOLDER'},
   {title:'QtSpatialAudio',key:'PROV-R290-07-C',kind:'FOLDER'}
  ],
...
export function auditDeepArchiveRecoveryR290(){
 ...
 const duplicatePublicKeys=R290_DEEP_RECOVERY_BINDINGS.flatMap(x=>x.driveArtifacts.map(a=>a.key)).filter((key,i,all)=>all.indexOf(key)!==i);
 const missingProof=R290_DEEP_RECOVERY_BINDINGS.filter(x=>!x.proofRequired.length||!x.boundary).map(x=>x.id);
 const pass=!duplicateIds.length&&!unknownMenus.length&&!routeMismatches.length&&!missingGenomeRefs.length&&!missingDrive.length&&!duplicatePublicKeys.length&&!missingProof.length;
 return {schema:R290_DEEP_RECOVERY_SCHEMA,revision:R290_DEEP_RECOVERY_REVISION,publicProvenanceBoundary:R291_PUBLIC_PROVENANCE_BOUNDARY,pass,bindings:R290_DEEP_RECOVERY_BINDINGS.length,duplicateIds,unknownMenus,routeMismatches,missingGenomeRefs,missingDrive,duplicatePublicKeys,missingProof,boundary:'Recovery bindings are planning/provenance overlays. They add no route owner, CanonState writer, proof authority, dispatcher, device claim or deployment authority.'};
}

export function deepArchiveRecoveryReceiptR290(){
 return {generatedAt:new Date().toISOString(),publicProvenanceBoundary:R291_PUBLIC_PROVENANCE_BOUNDARY,audit:auditDeepArchiveRecoveryR290(),bindings:R290_DEEP_RECOVERY_BINDINGS};
}