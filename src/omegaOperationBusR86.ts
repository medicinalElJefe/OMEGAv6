export type OmegaOperationTypeR86=
 ...
 |'COCKPIT_PROOF_REFRESHED'|'HOST_JOB_QUEUED'|'BUILD_MISSION_STARTED'|'HOST_JOB_PROOF_SELECTED'
 |'REFLEX_MISSION_ASSEMBLED'|'EVIDENCE_BOUND_SCENE_INGRESSED'|'MISSION_WORLD_CONTINUITY_BOUND'
 |'RENDER_ATTEMPT_CONTINUITY_ANCHORED'|'EVIDENCE_RECONSTRUCTION_INTENT_COMPILED';
