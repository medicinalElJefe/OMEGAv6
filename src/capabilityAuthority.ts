...
{name:'Field',family:'Living Membrane',implementation:'SPECIALIST',views:V('FIELD','SKIN','GRAPH'),boundary:'SOURCE_PACKET',purpose:'continuous packet field, continuity/scar geometry and admitted route interaction'},
{name:'Data Motion',family:'Persistent Packet',implementation:'SPECIALIST',views:V('FIELD','GRAPH','TRAVERSAL'),boundary:'SOURCE_PACKET',purpose:'source→next derivatives, normalized route velocity/acceleration and vector-field traversal'},
...
{name:'Convergence',family:'Living Membrane',implementation:'SPECIALIST',views:V('FIELD','GRAPH','EVIDENCE'),boundary:'SOURCE_PACKET',purpose:'rank route candidates, expose proof stages and commit selected atlas states'},
