...
export const R153_LAW='RETURNED HOST PROOF ADVANCES THE MISSION; DISCOVERY PRECEDES MUTATION; REPAIR IS READ-PROOF + PREIMAGE-SHA BOUND; PACKAGE FOLLOWS VERIFIED BUILD/TEST; COMPLETE IS NEVER INFERRED FROM QUEUE STATE';
...
export function manifestR153(){return{revision:R153_REVISION,schema:R153_MISSION_SCHEMA,maxCycles:R153_MAX_CYCLES,law:R153_LAW,stages:['DISCOVERY','PROJECT_DISCOVERY','NODE_PREFLIGHT','BUILD_VERIFY','REPAIR_READ','REPAIR_VERIFY','PACKAGE','COMPLETE'],repair:{maxAttempts:2,requiresReturnedReadPreimage:true,exactReplacementOnly:true,aiCanProposeButCannotBypassValidation:true},canonicalMutation:false,canonicalAdmissionAuthority:'R125'}}
