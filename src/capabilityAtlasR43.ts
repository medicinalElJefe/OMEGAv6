...
export const R43_DATASETS=[
 ...
 {id:'CERN_MASTER_R339',rows:4285,columns:68,label:'R339 Advanced Master v4 · R334 corpus plus ablation/forecast advancement layer'},
 {id:'CERN_ADV_R339',rows:25,columns:14,label:'R339 ADV-05→ADV-07 · ablation, round-trip, frozen forecast and governance evidence'}
] as const;
