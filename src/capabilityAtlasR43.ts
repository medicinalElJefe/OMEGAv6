...
export const R43_DATASETS=[
 ...
 {id:'CERN_MASTER_R339',rows:4285,columns:68,label:'R339 CERN/Omega Advanced Master v4 · exact R334 prefix + ablation/round-trip/frozen forecast suffix'},
 {id:'CERN_ADV_R339',rows:25,columns:14,label:'R339 ADV-05→ADV-07 · executable ablation, round-trip, forecast and continuance contract'}
] as const;
