...
export const R43_DATASETS=[
 ...
 {id:'CERN_MASTER_V4_R340',rows:4285,columns:68,label:'R340 Advanced Master v4 · ablation/round-trip/frozen forecast master · external full-file hash census'},
 {id:'CERN_ADV05_ADV07_R340',rows:25,columns:14,label:'R340 ADV-05→ADV-07 · exact executable ablation, round-trip and prospective forecast rows'}
] as const;
