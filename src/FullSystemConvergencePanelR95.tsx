...
export default function FullSystemConvergencePanelR95({onNavigate}:{onNavigate:(name:string)=>void}){
 ...
 return <details className='r95-convergence-authority' open>
  <summary><div><span>R153 · ONE-SYSTEM COMPLETION AUTHORITY</span><b>{c.ledger.systems} systems · 24 families · 36 controls · 18 capabilities · 12 master menus</b></div><strong>{c.restore.length?`${c.restore.length} REAL RESTORES REMAIN`:`24/24 SUCCESSORS ACCOUNTED · 0 RESTORATION DEBT`}</strong></summary>
