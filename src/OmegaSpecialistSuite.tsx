...
import RecursiveCanonBuildR239 from './RecursiveCanonBuildR239';
...
export default function OmegaSpecialistSuite(props:Props){
 ...
 if(panel==='Canon Evolution'||panel==='Governance')return wrap(<div><RecursiveCanonBuildR239/><OmegaGovernanceProjectMediaR29 variant={panel} record={record} address={address} onAddress={onAddress} onNavigate={onNavigate} status={status} restore={restore}/></div>);
