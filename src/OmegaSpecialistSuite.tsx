...
export default function OmegaSpecialistSuite(props:Props){
 ...
 if(panel==='Consolidation')return wrap(<div><OmegaSystemConsolidationR30 variant={panel} record={record} address={address} onAddress={onAddress} onNavigate={onNavigate} status={status} restore={restore} uiMode={props.uiMode} onUiMode={props.onUiMode}/><OmegaConvergenceMasterR314/></div>);
