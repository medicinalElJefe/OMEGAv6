...
export default function OmegaSpecialistSuite(props:Props){
 ...
 if(panel==='Convergence')return <div><OmegaAutonomicR125/><details className='r121-legacy-convergence' open><summary>R123 organism body · persistent seed → organ → branch → cell control</summary><OmegaOrganismR123/></details><details className='r121-legacy-convergence'><summary>R121 direct swarm body · compatibility / independent-cell control</summary><OmegaSwarmR121 record={record} state={state} address={address} onAddress={onAddress} onNavigate={onNavigate}/></details><details className='r121-legacy-convergence'><summary>Retained continuity / convergence field instrument</summary><OmegaFieldMotionConvergenceR28 variant={panel} record={record} state={state} address={address} onAddress={onAddress} onNavigate={onNavigate}/></details></div>;
