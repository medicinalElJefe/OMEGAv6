...
export default function OmegaSpecialistSuite(props:Props){
 ...
 if(panel==='Canon Evolution'||panel==='Governance')return wrap(<div><RecursiveSelfBuildR240/><OmegaGovernanceProjectMediaR29 variant={panel} record={record} address={address} onAddress={onAddress} onNavigate={onNavigate} status={status} restore={restore}/></div>);
