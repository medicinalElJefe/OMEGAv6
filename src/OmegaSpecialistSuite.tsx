...
import OmegaCapabilityFieldR137 from './OmegaCapabilityFieldR137';
...
export default function OmegaSpecialistSuite(props:Props){
 ...
 const capability=<OmegaCapabilityFieldR137 panel={panel} record={record} address={address} onAddress={onAddress} onNavigate={onNavigate} status={status} restore={restore}/>;
 const wrap=(content:any)=><div className='r137-capability-first'>{capability}{content}</div>;
