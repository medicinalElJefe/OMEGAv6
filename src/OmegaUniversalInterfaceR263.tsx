...
type Props={onNavigate:(route:string)=>void;compact?:boolean};
...
export default function OmegaUniversalInterfaceR263({onNavigate,compact=false}:Props){
 ...
 return <section className={`r263-universal ${compact?'compact':''}`} aria-label='OMEGA universal activity interface' data-r263-authority={R263_TRUTH_CONTRACT.authority} data-r263-activity={activity} data-r263-layer={layer} data-r263-compact={compact?'true':'false'}>
