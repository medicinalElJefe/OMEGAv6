...
export default function HybridParallelDevelopmentR256(){
 ...
 const model=useMemo(()=>{
  ...
  if(!recommendations.length&&freshRuns.length<12)recommendations.push('Keep using Hybrid normally. R256 is collecting enough returned runs to calibrate policy without inventing confidence from a tiny sample.');
