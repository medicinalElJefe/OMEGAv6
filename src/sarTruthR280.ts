...
export type SarMissingnessR280=
 |'NO_SOURCE'|'NATIVE_DATA_UNBOUND'|'CALIBRATION_UNBOUND'|'DERIVED_FIELD_UNBOUND'|'PAIR_REQUIRED'|'PROCESSING_REQUIRED'
 |'OUT_OF_SWATH'|'RADAR_SHADOW'|'LAYOVER'|'NO_COHERENCE'|'CLOUD_MASKED'|'ATMOSPHERICALLY_DEGRADED'|'INTERPOLATED_ONLY';
