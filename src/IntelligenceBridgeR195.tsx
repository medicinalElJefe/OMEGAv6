...
export default function IntelligenceBridgeR195(){
 ...
 useEffect(()=>{if(!lastRefresh)return;window.dispatchEvent(new CustomEvent(R195_INTELLIGENCE_EVENT,{detail:bridge}))},[bridge,lastRefresh]); // R196 read-only projection input; never queues work
