...
export type SarClosureFrontierItemR346={
 ...
 admissible:boolean;physicalAuthority:string;modeSequence:string;hybridOperation:null|{op:'SAR_R344_CLOSURE';authorizationRequired:true;requiredEvidence:string[]};
};
...
const DEPENDENCIES:Record<SarR342LayerId,SarR342LayerId[]>={
 ...
 PHYSICALLY_VALID_INTERFEROMETRIC_PHASE:['TOPS_SUBPIXEL_COREGISTRATION'],RADIOMETRIC_BACKSCATTER:['EXACT_ACQUISITION'],
 TERRAIN_FLATTENED_GAMMA0:['RADIOMETRIC_BACKSCATTER'],UNWRAPPED_PHASE:['PHYSICALLY_VALID_INTERFEROMETRIC_PHASE'],
 LOS_DISPLACEMENT:['UNWRAPPED_PHASE'],CORRECTED_LOS:['LOS_DISPLACEMENT'],FULL_3D_DEFORMATION:['LOS_DISPLACEMENT']
};
