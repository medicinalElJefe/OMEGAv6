...
export default function OmegaHomeR71({onEnter}:Props){
 ...
 const[depth,setDepth]=useState<SurfaceDepth>(()=>{try{return localStorage.getItem('omega.r132.depth')==='DEEP'?'DEEP':'FOCUS'}catch{return'FOCUS'}}),[inspectorTab,setInspectorTab]=useState<InspectorTab>('STATE');
