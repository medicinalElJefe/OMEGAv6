export const ACCEPTED_PRODUCTION_CONTRACT_R95={
 ...
 rolloverRule:'A new chat/session must recover this contract from repository state before making broad UI, renderer, navigation, capability, federation, layer-binding, data-freshness, proof-ledger, mode/calculus-fabric, corpus-source, empirical-validation, capability-membrane, or architecture replacements.'
} as const;
