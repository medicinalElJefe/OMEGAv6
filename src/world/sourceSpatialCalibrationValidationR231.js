...
export async function validateSourceSpatialCalibrationR231({frame,reconstruction,camera,validationEvidence,rmsThresholdPx=2,maxThresholdPx=5,minCorrespondences=4}={}){
 ...
 const core={r230FrameSha256:text(frame.frameSha256),r230ReceiptSha256:text(frame.receiptSha256),r228GeometrySha256:text(reconstruction.geometrySha256),r228ReceiptSha256:text(reconstruction.receiptSha256),cameraEvidenceSha256,validationEvidenceSha256:evidenceSha256,referenceFrame:frameName,correspondenceCount:rows.length,rmsResidualPx:round(rms),p95ResidualPx:round(p95),maxResidualPx:round(max),rmsThresholdPx:rmsLimit,maxThresholdPx:maxLimit,independentCorrespondenceValidationPassed:passed};
