...
export const R224_BOUNDARY='R224 makes the proven R218→R221→R219→R222 source-backed terrain chain operator-invokable and visually consumable inside the existing Living World. It acquires only complete canonical Worker-mediated USGS elevation evidence, carries only the exact already-proven R218 grid shape into the R222 handoff, projects only the proven terrain mesh, preserves mission/world/proof lineage, and does not infer depth, materials, radiometry, textures, camera calibration, empirical pixels, solver validity, native execution, federation closure, PC online state, Canon mutation, or computed photoreal reality.';
...
export async function assembleLivingTerrainExperienceR224({field,fetcher=globalThis.fetch,origin,persist=false}={}){
 ...
 const r222Input={...r221,mesh:{...r221.mesh,side:Number(field.side),spacingM:Number(field.spacingM)}};
 const terrain=await projectSourceBackedTerrainR222(r222Input);
...
export function manifestR224(){return{schema:'OMEGA_LIVING_TERRAIN_EXPERIENCE_MANIFEST_R224',revision:R224_REVISION,chain:['R217 exact-byte representational frame','R218 bounded WGS84 field','R221 canonical Worker-mediated complete elevation acquisition','R219 source-backed elevation mesh','exact R218 grid-shape carry','R222 deterministic terrain geometry','R224 operator-invoked adaptive Living World visual packet'],authority:{groundEvidence:'R9/R121',computedReality:'R122',adaptivePerformance:'R185 through inherited field profile',canonicalAdmission:'R125',operationContinuity:'R86/R87/R97 when available'},truthBoundary:R224_BOUNDARY};}
