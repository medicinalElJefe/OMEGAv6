...
export const R196_REVISION='R196.2';
export const R196_SCHEMA='OMEGA_LIVING_WORLD_INTELLIGENCE_PROOF_R196_2';
...
export const R196_LAWS=Object.freeze([
 ...
 'R195_1_INTELLIGENCE_STATUS_IS_PROJECTED_NOT_PROMOTED_TO_CANON',
 'R196_1_HELD_SAI_HYBRID_DRAFT_AUTHORITY_IS_PRESERVED',
...
export function projectLivingWorldIntelligenceProofR196({membrane=null,intelligence=null}={}){
 if(!acceptedMembrane(membrane))return{schema:R196_SCHEMA,revision:R196_REVISION,eventAccepted:false,worldId:null,intelligenceState:'HOLD_WORLD_PROOF_REQUIRED',nextAction:null,dispatchAuthorized:false,canonicalMutation:false,canonicalAdmissionAuthority:'R125',truthBoundary:'R196.2 cannot project intelligence status without an accepted R190.1 living-world proof membrane.'};
 ...
 return{
  ...
  authority:{world:'R136/R134',currentProof:'R190.1',intelligenceProjection:'R195.1',heldSaiHybridDraft:'R196.1',execution:'R146/R147',exactReturnProof:'R141',admission:'R125'},
  laws:R196_LAWS,
  truthBoundary:'R196.2 only projects current R195.1 intelligence/Hybrid capability state into the accepted R190.1 living-world proof membrane while preserving the R196.1 held SAI-to-Hybrid draft path. It does not prove model weights, native execution, solver validity, public deployment, federation closure, Earth truth, computed-photoreal reality, factual truth, or Canon admission.'
 };
}
...
export function manifestR196(){return{schema:R196_SCHEMA,revision:R196_REVISION,laws:R196_LAWS,inputAuthorities:['R190.1','R195.1','R196.1'],visualWorldAuthority:'R136/R134',executionAuthority:'R146/R147',exactReturnProofAuthority:'R141',canonicalAdmissionAuthority:'R125',dispatchAuthorized:false,canonicalMutation:false};}
