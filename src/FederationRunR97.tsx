...
export default function FederationRunR97({onDownloadLauncher,paired}:Props){
 ...
 return <section className='r97-federation r102-federation-instrument'>
  ...
  <div className='r102-handoff-caption'><span>END-TO-END PATH</span><b>Genesis → Optical → Sovereign Compute → OMEGAv6 admission</b><small>RCWA is a Sovereign solver worker, not a fifth federation authority.</small></div>
