...
export default function BioInstrumentSurfaceR281({address,onAddress}:Props){
 ...
 return <section className='bio281' aria-label='Heavy Bio instrument and all-mode visualization'>
  <header className='bio281-head'>
   <div><span>R282 · S10 BIOLOGICAL TRAVERSAL · MEDICAL PRODUCTION BASELINE</span><h3>Heavy Bio Instrument Surface</h3><p>Measured channels, calibration uncertainty, 20,736 Heavy Bio addressing, 12 domains, 12 context layers, seven physical scales, 241 analytical channels, and R282 medical-production release controls remain explicitly separated on one proof-aware surface.</p></div>
  ...
  <div className='bio281-kpis'>
   ...
   <article><span>CANON MODES</span><b>{frame.allModes.count}</b><small>overlay only · measurement authority 0</small></article>
