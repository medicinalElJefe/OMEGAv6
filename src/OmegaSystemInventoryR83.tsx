...
type Tab='SYSTEMS'|'FAMILIES'|'MENUS'|'CAPABILITIES'|'V77';
...
export default function OmegaSystemInventoryR83({onNavigate,compact=false,initialTab='SYSTEMS'}:Props){
 ...
 return <section className={'r83-inventory '+(compact?'compact':'full')}>
  <header className='r83-inventory-head'><div><span>OMEGA COMPLETE SOFTWARE INDEX · PRESERVE BEFORE PRUNE</span><h3>Integrated systems navigator</h3><p>44 application surfaces are only the route layer. This index keeps the larger software lineage visible without pretending every historical donor is executing.</p></div><div className='r83-inventory-kpis'><b>100</b><small>systems</small><b>24</b><small>families</small><b>36</b><small>menu options</small><b>18</b><small>capabilities</small><b>24</b><small>V77 bins</small></div></header>
  ...
  <label className='r83-inventory-search'><Search/><input value={query} onChange={e=>setQuery(e.target.value)} placeholder='Search systems, families, menus, capabilities or V77 bins…'/></label>
