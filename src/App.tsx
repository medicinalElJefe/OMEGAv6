...
function App(){return <AppBoundary><Suspense fallback={<div className='boot'><b>OMEGA {RUNTIME_IDENTITY.hostedBuild} · {RUNTIME_IDENTITY.runtimeContract}</b><span>Starting source-bound sovereign workstation…</span></div>}><OmegaWorkstation/></Suspense></AppBoundary>}
export default App;
