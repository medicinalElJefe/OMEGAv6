...
/* R317 product-composition repair: one canonical visible navigator owns the product surface.
   R257 remains available as an experience/context model, but its duplicate outer navigation chrome
   is not mounted around R71/R88. Truth/proof/execution authorities remain unchanged. */
import './index.css';
