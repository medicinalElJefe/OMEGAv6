...
export default function OmegaBuildPotentialR133({onNavigate,compact=false}:Props){
 ...
 return <section className={'r133-potential '+(compact?'compact':'full')}>
  ...
  {proofError&&<div className='r137-proof-error'><TriangleAlert/>{proofError} · missing runtime evidence remains unknown; effective/historical family states are not rewritten by this probe.</div>}
