...
const OVERRIDE:Record<string,{successor:SuccessorReality;surface:string;proof:string;remaining:string}>={
 ...
 S03:{successor:'DEVICE_GATED',surface:'Hybrid Link',proof:'typed mission/status/proof contracts + R127 zero-drift transport',remaining:'paired PC/phone execution requires current returned device proof'},
 ...
 S12:{successor:'LOCAL_ACTIVE',surface:'Build Out',proof:'R46 portable sovereign seed export',remaining:'self-deploying installer execution remains native gated'},
 ...
 S16:{successor:'LOCAL_ACTIVE',surface:'Plugins / System Atlas',proof:'R153 CSV/JSON/XLSX SHA-256 intake + real first-sheet XLSX parsing + bounded XLSX round-trip writer',remaining:'Excel macro execution and formula recalculation remain outside browser execution; stored formula values are read without inventing recalculation'},
