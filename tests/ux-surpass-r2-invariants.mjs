...
must(!app.includes("import OmegaLauncher from './OmegaLauncher'")&&!app.includes('<OmegaLauncher'),'duplicate fixed Nexus launcher must not be globally mounted');
...
must(bridge.includes('SingleFrameRuntimeShellR27')&&!bridge.includes('nav20-desktop'),'legacy shell path must be compatibility-only');
...
console.log('UX_SURPASS_R2_INVARIANTS PASS · shared 44-route lineage + R27 single-frame navigation + no duplicate global launcher');