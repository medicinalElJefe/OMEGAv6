...
for(const route of ['Canon Evolution','Governance','Projects','Assets','Render Queue'])assert.match(suite,new RegExp(route.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),`R29 specialist router missing ${route}`);
