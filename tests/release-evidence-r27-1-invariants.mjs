...
for(const source of [worker,panel,config,vite,ci])must(!source.includes('@appdeploy/client')&&!source.includes('appdeploy.ai'),'R27.1+ must remain AppDeploy-free');
console.log(`OMEGA R31.2 RELEASE EVIDENCE PASS · package ${pkg.version} · packaged source != candidate != promoted merge; merge-parent rollback lineage governed`);
