...
const worker115=fs.existsSync('src/workerR115.js')?fs.readFileSync('src/workerR115.js','utf8'):'';
...
const wrappedR115=config.includes('"main": "src/workerR115.js"')&&worker115.includes("from './workerR114.js'")&&worker114.includes("from './workerR111.js'")&&worker111.includes("from './workerR102.js'")&&worker102.includes("from './workerR101.js'")&&worker101.includes("from './workerR34.js'")&&worker34.includes("from './workerR33.js'")&&worker33.includes("from './workerR32.js'")&&worker32.includes("import r27 from './workerR27.js'");
const wrappedR116=config.includes('"main": "src/workerR116.js"')&&worker116.includes("from './workerR115.js'")&&worker115.includes("from './workerR114.js'")&&worker114.includes("from './workerR111.js'")&&worker111.includes("from './workerR102.js'")&&worker102.includes("from './workerR101.js'")&&worker101.includes("from './workerR34.js'")&&worker34.includes("from './workerR33.js'")&&worker33.includes("from './workerR32.js'")&&worker32.includes("import r27 from './workerR27.js'");
must(directR27||wrappedR27||wrappedR33||wrappedR34||wrappedR101||wrappedR102||wrappedR111||wrappedR114||wrappedR115||wrappedR116,'R27 release-evidence wrapper must be deployed directly or preserved through the proven R32/R33/R34/R101/R102/R111/R114/R115/R116 successor chain');
...
for(const source of [worker,worker32,worker33,worker34,worker101,worker102,worker111,worker114,worker115,worker116,panel,config,vite,ci])must(!source.includes('@appdeploy/client')&&!source.includes('appdeploy.ai'),'R27.1+ must remain AppDeploy-free');
console.log(`OMEGA R116 RELEASE EVIDENCE PASS · package ${pkg.version} · R31.2 merge-parent lineage preserved through R32/R33/R34/R101/R102/R111/R114/R115/R116 successor chain`);