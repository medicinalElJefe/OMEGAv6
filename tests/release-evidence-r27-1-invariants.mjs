...
must(directR27||wrappedR27,'R27 release-evidence wrapper must be the deployed Worker entrypoint or preserved through proven R32 successor');
...
for(const source of [worker,worker32,panel,config,vite,ci])must(!source.includes('@appdeploy/client')&&!source.includes('appdeploy.ai'),'R27.1+ must remain AppDeploy-free');
console.log(`OMEGA R32 RELEASE EVIDENCE PASS · package ${pkg.version} · R31.2 merge-parent lineage preserved through successor wrapper`);
