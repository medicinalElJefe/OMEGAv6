...
const worker=read('src/workerR102.js'),worker111=fs.existsSync('src/workerR111.js')?read('src/workerR111.js'):'',worker114=fs.existsSync('src/workerR114.js')?read('src/workerR114.js'):'',worker115=fs.existsSync('src/workerR115.js')?read('src/workerR115.js'):'',worker116=fs.existsSync('src/workerR116.js')?read('src/workerR116.js'):'',ui=read('src/FederationRunR97.tsx'),css=read('src/federationRunR97.css'),css112=fs.existsSync('src/federationRunR112.css')?read('src/federationRunR112.css'):'',vite=read('vite.config.ts'),wrangler=read('wrangler.jsonc'),router=read('src/federation/federationIntentRouterR103.js');
...
const r116PreservesR103=wrangler.includes('"main": "src/workerR116.js"')&&worker116.includes("from './workerR115.js'")&&worker115.includes("from './workerR114.js'")&&worker114.includes("from './workerR111.js'")&&worker111.includes("from './workerR102.js'");
must(r102Direct||r111PreservesR103||r114PreservesR103||r115PreservesR103||r116PreservesR103,'R103 task-first routing must remain active directly through R102 or through an additive R111/R114/R115/R116 successor');
...
console.log('R103/R112/R116 TASK-FIRST ROUTER PASS · minimal capability graph · optional-stage preservation · truthful live gate · stable R102 contract preserved through additive R111/R114/R115/R116 mesh · simplified responsive outcome-first successor · route-deferred specialists');
