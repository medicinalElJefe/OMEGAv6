...
assert.ok(surface.includes("cap.dataset.r356CapabilityReady==='true'")&&surface.includes('cap.dataset.r356CapabilityReadyKey===stateKey')&&surface.includes('cap.dataset.r356CapabilityBindingKey===stateKey'),'R356 interaction readiness must wait for exact panel/state live-capacity settlement');
