...
assert.ok(navigationProof.includes('activateRailRoute')&&navigationProof.includes("root.dataset.omegaRouteState==='REQUESTED'")&&navigationProof.includes('root.dataset.omegaRouteTarget===name')&&navigationProof.includes("root.dataset.omegaRouteState==='COMMITTED'")&&navigationProof.includes('root.dataset.omegaRouteCurrent===name'),'R356 persistent navigation proof must separate requested target from exact committed route lifecycle');
assert.ok(disclosureProof.includes('beforeEpoch')&&disclosureProof.includes("root.dataset.omegaRouteState==='REQUESTED'")&&disclosureProof.includes('root.dataset.omegaRouteTarget===name')&&disclosureProof.includes("root.dataset.omegaRouteState==='COMMITTED'")&&disclosureProof.includes('root.dataset.omegaRouteCurrent===name'),'R356 disclosure proof must separate acknowledged route request from exact committed lifecycle');
