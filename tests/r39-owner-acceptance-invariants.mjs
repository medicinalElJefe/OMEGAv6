...
const law=read('src/calculusVisualLawR37.ts'),field=read('src/CalculusFieldR37.tsx'),hybrid=read('src/HybridMissionControlR8.tsx'),launcher=read('src/sovereignLauncherR117.ts'),deck=read('src/OmegaCommandDeck.tsx'),earth=read('src/EarthNowInstrument.tsx'),observatory=read('src/EarthObservatoryR8.tsx'),nav=read('src/deepInteractionR39_2.css');
