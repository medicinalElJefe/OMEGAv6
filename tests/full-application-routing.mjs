...
must(!v2.includes("'Plugins','Settings'")&&!v2.includes("'Development','Canon Evolution','SAI Lab','Governance','Consolidation'"),'donor/debt routes must not remain grouped as active specialist routes');
...
must(shell.includes('filter(isPrimaryOperationalCapability)'),'primary navigation must filter donor/debt capabilities');
must(shell.includes('data-capability-reality'),'operational routes must expose their actual capability boundary');
