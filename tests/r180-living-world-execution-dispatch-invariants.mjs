...
const authorizeControl=surface.indexOf('onClick={authorizeReady}'),dispatchControl=surface.indexOf('onClick={dispatchAuthorized}');assert.ok(authorizeControl>=0&&dispatchControl>authorizeControl,'R180 surface must preserve authorization control before dispatch control');
