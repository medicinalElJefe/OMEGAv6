...
assert.match(surpass,/Relativity\+/);assert.match(surpass,/20,736 Field\+/);assert.match(surpass,/Forecast\+/);assert.match(surpass,/Atlas Calc\+/);assert.match(surpass,/Infinity\+/);assert.match(surpass,/Scale\+/);assert.match(surpass,/Reality\+/);
