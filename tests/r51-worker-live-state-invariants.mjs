...
const workflow=fs.readFileSync('.github/workflows/r51-live-state.yml','utf8');
...
if(!workflow.includes('/api/live-state-spine')||!workflow.includes('OMEGA_WORKER_LIVE_STATE_R51')||!workflow.includes('R51 LIVE STATE SPINE PASS'))throw new Error('R51 public endpoint must have post-promotion verification');
