...
if(!workflow.includes('/api/live-state-spine')||!workflow.includes('OMEGA_WORKER_LIVE_STATE_R51')||!workflow.includes('R51 LIVE STATE SPINE PASS'))throw new Error('R51 historical public-endpoint verifier semantics must remain preserved');
console.log(`R51 Worker live-state invariants PASS · workflow lineage ${workflowPath}`);
