...
if(await motion.getAttribute('data-r243-transport')!=='R242')throw new Error('R243 motion surface did not preserve inherited R242 transport identity');
...
console.log('OMEGA R243 BUILT BROWSER PASS · current R243 surface accepts inherited R242 execution-motion transport · selected authenticated host RUNNING job exposes a live renewable lease · exact current step HASH_TREE S02 · 1/3 returned-step boundary · elapsed time · no prose-only INVOKED ambiguity');
await browser.close();
