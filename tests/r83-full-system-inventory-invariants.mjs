...
must(browserProof.includes('verifyR305InteractionEnvelope')&&browserProof.includes('buriedTargets')&&browserProof.includes('undersizedTouchActions')&&browserProof.includes('undersizedTouchForms'),'R305 interaction authority proof must remain converged with the no-burial audit');
must(browserProof.includes('verifyReachabilityFabric')&&browserProof.includes('data-reachability-pass')&&browserProof.includes('data-reachability-residual-count'),'real browser proof must open the System map and prove the R305 audit clean');
