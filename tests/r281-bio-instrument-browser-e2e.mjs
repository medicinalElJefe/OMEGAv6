// R313 browser convergence wrapper. Preserve the exact inherited R281 proof, expose Command Center scroll geometry without weakening acceptance, run the all-surface no-dead-control audit, then prove safe full-control interaction and recursively verify every native/details + safe aria-expanded panel disclosure on desktop and mobile.
