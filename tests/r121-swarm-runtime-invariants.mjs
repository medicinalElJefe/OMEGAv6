...
assert.match(cell,/x-omega-swarm-runtime':'R121/);
...
assert.ok(wrangler.includes('"OmegaSwarmCell": {"type": "durable-object", "storage": "sqlite"}'),'R121 cell namespace must remain live on SQLite under declarative exports');
assert.ok(wrangler.includes('"OmegaSwarmCoordinator": {"type": "durable-object", "storage": "sqlite"}'),'R121 coordinator namespace must remain live on SQLite under declarative exports');
