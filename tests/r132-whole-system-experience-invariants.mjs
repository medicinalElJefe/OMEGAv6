...
must(home.includes("aria-label='All tools'")&&home.includes('activeWorkspace.routes.map'),'historical route reachability must remain complete while visible and accessible Home language agree');
...
console.log('R132/R239 WHOLE-SYSTEM EXPERIENCE PASS · one visual-first instrument · workspace/start-here/all-tools hierarchy · primary/support/expert grouping · focus/deep density · complete 44-route reachability · aligned accessibility · technical detail on demand');
