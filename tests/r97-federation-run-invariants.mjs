...
must(r34.includes("cache:'no-store'")&&r34.includes("cf:{cacheTtl:0}")&&r34.includes('omega_federation_probe=r97'),'Worker-to-Worker health probes must bypass stale edge responses');
