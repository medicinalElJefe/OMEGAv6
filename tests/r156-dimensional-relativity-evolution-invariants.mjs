...
for(const token of [
 ...
 "state:'DERIVED_CANDIDATE_R125_ADMISSION_REQUIRED'",
...
for(const token of ['R156 · ALL-MODE DIMENSIONAL RELATIVITY EVOLUTION','NESTED FRAME MAP','symmetry ≠ 1 − asymmetry','PRUNE_01-1','CONSTRUCT_011','37 / 73 REFERENCE KERNEL','ALL-MODE PRESSURE FIELD','evolution.evolutionCandidate.state'])must(panel.includes(token),`panel missing ${token}`);
