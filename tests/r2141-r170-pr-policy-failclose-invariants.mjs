...
console.log('R221.1 R170 RUNTIME HYGIENE PASS · held candidate branches block regeneration · known repository-policy rejection remains truth-gated · unexpected PR errors still fail · v7 GitHub actions avoid Node-20 runtime deprecation · R125/no-direct-main/no-auto-merge boundaries preserved');
