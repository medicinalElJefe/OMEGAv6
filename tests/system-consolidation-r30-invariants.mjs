...
for(const token of ['OMEGA_NAVIGATION','CAPABILITY_BY_NAME','omega.v6.settings.r30','data-omega-density','data-omega-motion','/api/status','/api/release-evidence','/omega-build-receipt.json','localStorage.length','OMEGA_CONSOLIDATION_R30','PLAN_ONLY_NO_SOURCE_MUTATION'])assert.match(app,new RegExp(token.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')),`R30 system contract missing ${token}`);
