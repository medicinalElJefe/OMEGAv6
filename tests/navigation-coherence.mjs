...
const navigationBlock=navigation.slice(navigation.indexOf('export const OMEGA_NAVIGATION=['),navigation.indexOf('export const OMEGA_NAV_GROUPS'));
const registeredBlock=(shell.match(/R27_REGISTERED_SURFACES=\[(.*?)\] as const/s)||[])[1]||'';
const nav=[...navigationBlock.matchAll(/name:'([^']+)'/g)].map(x=>x[1]);
