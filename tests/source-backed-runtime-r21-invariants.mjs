...
for(const recovered of ['Mother_Mode=Water_Basin·0\.618\+Compression_Vector·0\.382','Father_Mode=Structure_Vector·0\.618\+Traversal_Vector·0\.382','Base_Coherence\+Mother_Mode\+Father_Mode\+Water_Basin'])assert.match(runtime,new RegExp(recovered));
