...
console.log('R207 R141-NATIVE HOST EVIDENCE PASS · runtime-pinned immutable R205 executor SHA · inherited executor contract validated before load · exact semantic return envelope · no expanded execution authority · R125 preserved');
