...
for(const token of ['R283 · OBSERVED EARTH GLOBE','/api/earth/gibs/global','createImageBitmap','createWgs84Orthographic','WGS84 ELLIPSOID','EPSG:4326','15°/hour rotation','SOURCE BRIGHTNESS','DERIVED UTC GEOMETRY','Truth boundary.','unavailable source imagery is not replaced'])must(observed.includes(token),'R283 observed-globe contract missing '+token);
for(const token of ['WGS84_F=1/298.257223563','geodeticToEcef','createWgs84Orthographic','inverseOrthoWgs84','forwardOrthoWgs84','solarPoint','terminatorGeodetic'])must(projection.includes(token),'R283 WGS84 projection kernel missing '+token);
