...
for(const kind of ['experience-hybrid','experience-matter','experience-relativity','experience-earth'])if(!work.includes(kind))throw new Error('missing shared phase context '+kind);
