...
for(const [panel,kind] of [['HybridMissionControlR8','hybrid'],['MatterTraversalR36','matter'],['RelativityLab','relativity'],['EarthObservatoryR8','earth']]){
  if(!work.includes(`withPhase(<${panel}`)||!work.includes(`>,'${kind}')`))throw new Error('missing shared phase context '+kind);
}
