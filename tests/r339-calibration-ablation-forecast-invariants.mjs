...
assert.equal(R339_FORECAST_CONTRACT.referenceCovariance.sigmaFL,R334_COMMON_STATE.fLUncertainty);
assert.equal(R339_FORECAST_CONTRACT.referenceCovariance.sigmaCParallel,R334_COMMON_STATE.cParallelUncertainty);
assert.equal(R339_FORECAST_CONTRACT.referenceCovariance.correlation,R334_COMMON_STATE.nativeCorrelation);
assert.deepEqual(forecastReferenceCovarianceR339(),R339_FORECAST_CONTRACT.referenceCovariance.matrix.map(row=>[...row]));
...
assert.equal(R339_FORECAST_CONTRACT_SHA256,'fdee3585d75c0bc887342fbf9ffef89b00c8dc8eddeaec7ba5433a960c5d7671');
