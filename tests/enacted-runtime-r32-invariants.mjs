...
must((direct||successor33||successor34||successor101||successor102||successor111||successor114)&&config.includes('OMEGA_RUNTIME')&&config.includes('OmegaRuntime')&&config.includes('new_sqlite_classes'),'Wrangler durable runtime binding or R33/R34/R101/R102/R111/R114 successor missing');
...
must(shell.includes("'WORK'|'EXPLORE'|'INTELLIGENCE'|'EVIDENCE'|'SYSTEM'"),'R31 human navigation hierarchy must survive R32/R33/R34/R101/R102/R111/R114');
console.log('OMEGA R32 ENACTED RUNTIME PASS · durable event/action bus + governed AI + authenticated Hybrid proof transport preserved under R114→R111→R102');