...
must(launcher.includes('OMEGA_CONNECT_THIS_PC_R112.cmd')&&launcher.includes('/api/hybrid/agent-download?r112=1')&&launcher.includes('/api/federation/rcwa/agent-download?r112=1'),'accepted R112 fallback launcher must bind general Hybrid plus optional RCWA transport');
...
console.log(`R111/R116 FEDERATED CAPABILITY MESH PASS · neutral observer identity preserves four authority observations · scalable services · ${surfaces.length} dynamic route/output contracts · R116 current one-touch Hybrid recovery layered over R112 fallback · R114 closure inherited · R115 machine adapters remain service-only · independent advisory sentinel`);
