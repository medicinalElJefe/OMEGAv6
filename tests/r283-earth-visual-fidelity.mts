...
import {dot3,forwardOrthoWgs84,geodeticNormal,geodeticToEcef,inverseOrthoWgs84,solarPoint,terminatorGeodetic,wrapLon,WGS84_B,WGS84_F} from '../src/earthProjectionR283.ts';
...
const centers:[[number,number],...[number,number][]]=[[0,0],[32.2217,-110.9265],[70,45],[-50,170]];
...
const equinox=solarPoint(new Date('2026-03-20T12:00:00.000Z'));
...
console.log('R283 EARTH VISUAL FIDELITY PASS · WGS84 ellipsoid round-trip projection · dateline continuity · equinox solar geometry · exact UTC terminator orthogonality');
