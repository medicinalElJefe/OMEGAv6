...
assert(nav.includes('r89-flat-scroll')&&nav.includes('rows.map(route=>')&&!nav.includes('rows.slice('),'all 44 routes must stay directly scroll-reachable without route slicing');
...
console.log('PASS interface hierarchy invariant · R104 readable persistent side navigation preserves viewport-first product behavior');
