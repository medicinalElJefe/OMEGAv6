...
const operational=['<SovereignConnectionR117/>','<HybridHostIntelligenceR238/>','<HybridResourceGovernorR239/>','<HybridActionRuntimeR247/>','<HybridOutcomeClosureR254/>','<HybridHostEffectsR212/>','<HybridCommandDeckR237/>','<HybridProofClosureR141/>'];
...
console.log('startup experience invariants: PASS · 44 routes + R259/R260 continuity + R261.1 browser polish + R263 universal interface + compact specialist viewport + primary Hybrid controls and R212→R237→R141 closure preserved');
