...
const status={state:'VERIFIED_DEVICE_ONLINE',nativeExecutionClaimed:true,executionMotionRevision:'R243',runningLeaseMs:20000,devices:[{id:'dev-r243',name:'OMEGA MOTION PC',online:true,revoked:false,lastSeen:now-500,rootLabel:'J:/',capabilities:caps,proofExtensions:['R205','R238','R240','R242']}],jobs:[running]};
