...
await import('./r262-parallel-adaptive-development-invariants.mjs');
...
assert.ok(surface.includes("const CORPUS_EVENT='omega:r255:corpus-updated'")&&surface.includes('new CustomEvent(CORPUS_EVENT'),'R255 must emit same-tab sanitized corpus evolution for R262 without another network poller');
...
console.log('R255 Hybrid experience-ledger invariants: PASS · R116 preserved · shared authenticated R238 epoch reused · bounded local corpus · same-tab R262 signal · sanitized export · no new execution authority');
