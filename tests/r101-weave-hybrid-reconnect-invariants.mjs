...
must(![worker,worker114,adapter,hybrid,sovereign,launcher,weave,stage].join('\n').includes('@appdeploy/client'),'R101 must remain provider portable');

console.log('R101 WEAVE + HYBRID PASS · 44 routes intact · weave-derived effective atlas resolution · Field/Weave/Projection strata · bridge-ID reconnect/repair · authenticated-heartbeat truth preserved through R114→R112');
