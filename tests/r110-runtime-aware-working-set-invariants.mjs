...
console.log(`R110/R229/R270/R288/R289/R290/R291 RUNTIME-AWARE WORKING SET PASS · ${surfaces.length} registered destinations preserved dynamically · archive-native + unified R289 convergence/navigation · canonical R290 Singmaster exact proof-atlas · R290 deep recovery · R291 exact-head release/browser contract gates chained · hidden/Save-Data/2G suppression · low-power/3G budget reduction · direct route demand preserved · Home deferred · exactly one branded suspense boundary · workstation-only shared R238 provider · 500 KiB initial-entry budget enforced · R201/R203 deleted tombstones retained without live bindings · one route/state/proof authority retained`);
