...
for(const token of [
 ...
 's?.result?.hostProfileR238',
 'RETURNED_HOST_PROOF',
 'RCWA PYTHON DEPENDENCY',
 'LOCAL MACRO STORE',
 'Hardware presence does not prove CUDA runtime',
