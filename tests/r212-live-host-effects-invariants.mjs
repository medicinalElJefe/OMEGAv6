...
for(const token of [
 ...
 'data-r212-selected-device','data-r212-snapshot-epoch','selectedDeviceJobs','otherHostTerminalCount','same selected authenticated host and the same atomic Hybrid/Mission snapshot epoch','last successful shared snapshot remains displayed'
...
console.log('OMEGA R212/R238/R270 LIVE HOST EFFECTS PASS · one workstation-scoped selected-device/snapshot epoch · no duplicate observer polling · selected-host return isolation · source mutations only from returned APPLY_PATCH/WRITE_TEXT · R141/R146/R147/R125 preserved');
