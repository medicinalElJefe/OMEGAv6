...
assert.ok(R153_FULL_SYSTEM_CONTRACT.nativeRootPolicy.includes('J:\\'),'preferred J root must remain explicit');assert.match(R153_FULL_SYSTEM_CONTRACT.nativeRootPolicy,/Never silently fall back to C:/);
