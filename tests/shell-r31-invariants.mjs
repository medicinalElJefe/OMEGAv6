...
must(r32Labels||r33Labels||r156LiveLabels,'mobile labels must preserve the R32/R33 destination semantics; R156 may add current authenticated PC state without changing the Hybrid Link destination');
...
console.log('R31/R32/R33/R156 shell invariants PASS · destination semantics preserved while live authenticated PC state may refine the label');
