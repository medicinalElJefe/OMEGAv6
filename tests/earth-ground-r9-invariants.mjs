...
must(directR9||wrappedR9||r32WrappedR9||r33WrappedR9||r34WrappedR9,'Cloudflare must execute R9 directly or through a proven successor wrapper that preserves R9');
console.log('EARTH_GROUND_R9 PASS · WGS84 Earth→ground + KartaView/USGS/OSM/GIBS returned-source contracts locked · successor chain proven through R34');
