...
must(directR33||r34PreservesR33||r101PreservesR33||r102PreservesR33,'R33 living runtime must remain active directly or through the proven R34/R101/R102 successor chain');
...
for(const source of [worker,worker32,worker34,worker101,worker102,agent,shell,pulse,config])must(!source.includes('@appdeploy/client')&&!source.includes('appdeploy.ai'),'living runtime must remain AppDeploy-free');
console.log('OMEGA R33b LIVING RUNTIME PASS · preserved through R34/R101/R102 federation + reconnect successor');
