...
async function verifyR305InteractionEnvelope(page,viewportName){
  const state=await page.evaluate(()=>{
    ...
    return{
      coarse,reduced,targetCount:targets.length,undersized,modeButtons,
      transitionDuration:routeStyle?.transitionDuration||'',animationDuration:routeStyle?.animationDuration||'',
