...
const must=(ok,msg)=>{if(!ok)throw new Error('R88/R89/R229/R299/R302/R304 '+msg)};
...
must(!css210.includes('/api/')&&!css210.includes('fetch(')&&!polish.includes('/api/')&&!polish.includes('fetch('),'R304 visual polish must remain presentation-only');
