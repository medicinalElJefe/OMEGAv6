...
const worker=read('src/workerR114.js'),latest=fs.existsSync('src/workerR115.js')?read('src/workerR115.js'):'',successor=fs.existsSync('src/workerR116.js')?read('src/workerR116.js'):'',wrangler=read('wrangler.jsonc'),ui=read('src/FederationCeremonyR114.tsx'),surface=read('src/FederationRunR97.tsx'),contract=read('src/acceptedProductionR114.ts'),federation=JSON.parse(read('public/omega-federation.json')),queue=JSON.parse(read('public/omega-fullwave-queue.schema.json')),r34=read('src/workerR34.js');
...
const direct114=wrangler.includes('"main": "src/workerR114.js"');
const via115=wrangler.includes('"main": "src/workerR115.js"')&&latest.includes("import r114,{OmegaRuntime as OmegaRuntimeR114} from './workerR114.js'");
const via116=wrangler.includes('"main": "src/workerR116.js"')&&successor.includes("import r115,{OmegaRuntime as OmegaRuntimeR115} from './workerR115.js'")&&latest.includes("import r114,{OmegaRuntime as OmegaRuntimeR114} from './workerR114.js'");
assert(direct114||via115||via116,'Wrangler must promote R114 directly or through an explicit R115/R116 successor chain that inherits R114');
