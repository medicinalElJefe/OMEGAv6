...
console.log(`R105/R239/R242 LIVE DATA TRUTH + SUBMENU PASS · ${registeredRoutes.length} registered routes preserved through canonical R242 lemma transform · 6 contextual submenus · complete All Tools recovery · current canonical recurrence separated from 2025 donor samples · current-session performance truth enforced`);
