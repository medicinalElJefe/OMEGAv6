...
must(directR8||wrappedR8||transitivelyWrappedR8||r32WrappedR8||r33WrappedR8,'Cloudflare must execute R8 directly or through a proven successor wrapper chain that preserves R8');
console.log('RESTORE_DEPTH_R8 PASS · Earth evidence + NOAA 9-coverages + V87-V90 typed Hybrid contract + B059 SAI active · R33 successor chain proven');
