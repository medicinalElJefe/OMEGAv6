...
const r111WrappedR8=wrangler.includes('"main": "src/workerR111.js"')&&r111.includes("from './workerR102.js'")&&r102.includes("from './workerR101.js'")&&r101.includes("from './workerR34.js'")&&r34.includes("from './workerR33.js'")&&r33.includes("from './workerR32.js'")&&r32.includes("import r27 from './workerR27.js'")&&r27.includes("import r9 from './workerR9.js'")&&r9.includes("import r8 from './workerR8.js'");
const r114WrappedR8=wrangler.includes('"main": "src/workerR114.js"')&&r114.includes("from './workerR111.js'")&&r111.includes("from './workerR102.js'")&&r102.includes("from './workerR101.js'")&&r101.includes("from './workerR34.js'")&&r34.includes("from './workerR33.js'")&&r33.includes("from './workerR32.js'")&&r32.includes("import r27 from './workerR27.js'")&&r27.includes("import r9 from './workerR9.js'")&&r9.includes("import r8 from './workerR8.js'");
const r115WrappedR8=wrangler.includes('"main": "src/workerR115.js"')&&r115.includes("from './workerR114.js'")&&r114.includes("from './workerR111.js'")&&r111.includes("from './workerR102.js'")&&r102.includes("from './workerR101.js'")&&r101.includes("from './workerR34.js'")&&r34.includes("from './workerR33.js'")&&r33.includes("from './workerR32.js'")&&r32.includes("import r27 from './workerR27.js'")&&r27.includes("import r9 from './workerR9.js'")&&r9.includes("import r8 from './workerR8.js'");
const r116WrappedR8=wrangler.includes('"main": "src/workerR116.js"')&&r116.includes("from './workerR115.js'")&&r115.includes("from './workerR114.js'")&&r114.includes("from './workerR111.js'")&&r111.includes("from './workerR102.js'")&&r102.includes("from './workerR101.js'")&&r101.includes("from './workerR34.js'")&&r34.includes("from './workerR33.js'")&&r33.includes("from './workerR32.js'")&&r32.includes("import r27 from './workerR27.js'")&&r27.includes("import r9 from './workerR9.js'")&&r9.includes("import r8 from './workerR8.js'");
must(directR8||wrappedR8||transitivelyWrappedR8||r32WrappedR8||r33WrappedR8||r34WrappedR8||r101WrappedR8||r102WrappedR8||r111WrappedR8||r114WrappedR8||r115WrappedR8||r116WrappedR8,'Cloudflare must execute R8 directly or through a proven successor wrapper chain that preserves R8');
console.log('RESTORE_DEPTH_R8 PASS · Earth evidence + NOAA 9-coverages + V87-V90 typed Hybrid contract + B059 SAI active · R109 deferred UI binding allowed · successor chain proven through R116→R115→R114→R111→R102');