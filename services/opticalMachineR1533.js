...
import {createOpticalExternalToolR1533,R1533_TOOL_NAME,R1533_TOOL_VERSION,R1533_TOOL_SCHEMA,R1533_TOOL_AUTHORITY,fullwaveAdmissibilityR1533} from './opticalExternalToolR1533.js';
...
async function route(request){
 ...
 if(request.method==='GET'&&u.pathname==='/api/optical/manifest'){
  ...
  return new Response(JSON.stringify({...body,machineVersion:R1533_MACHINE_VERSION,authority:R1533_MACHINE_AUTHORITY,capabilities,externalTool:tool.descriptor(origin),fullwaveGeometryGate:fullwaveAdmissibilityR1533},null,2),{status:original.status,headers:h});
 }
