...
try{
  ...
  await page.waitForFunction(()=>globalThis.OMEGA_SAR_R4_RUNTIME?.release==='R4-R256'&&globalThis.OMEGA_SAR_EXPERIENCE?.ready===true&&globalThis.OMEGA_SAR_PRIMARY_WORKSTATION?.state==='READY'&&globalThis.OMEGA_DATA_NATIVE_SURFACE?.state==='READY',null,{timeout:30000});
  ...
  const initial=await page.evaluate(()=>{
    ...
    return {vw:innerWidth,vh:innerHeight,map,visibleMap,top,dock,search,controls,transport,hits,layout:globalThis.OMEGA_SAR_R4_RUNTIME.experience.layout,surface:globalThis.OMEGA_SAR_PRIMARY_WORKSTATION.surface,nativeSurface:globalThis.OMEGA_DATA_NATIVE_SURFACE.surface};
  });
  ...
  console.log('SAR_R4_R256_PRIMARY_WORKSTATION_PASS',JSON.stringify({initial,measured,afterZoom,evidence},null,2));
