...
from processor.omega_sar import read_gunw, export_gunw, phase_to_range_change_m
...
def test_export_preserves_phase_and_corrections_separately(tmp_path):
    ...
    with rasterio.open(m['products']['unwrapped_phase_rad']) as ds:
        assert ds.crs.to_epsg()==32612 and ds.tags()['OMEGA_KIND']=='MEASURED_SOURCE_LAYER'
