...
// R260.7 gives the existing calibrated regional COG reader a direct bounded liveness
// path when repeated camera/source events starve its presentation debounce. It has no
// measurement, calibration, geolocation, authority, or admission-promotion authority.
import './sar-regional-liveness-runtime.mjs';
...
// R260.8 stabilizes only the explicit SAR primary-camera command after the workstation
// exists. It does not select new evidence or alter measurement/Canon authority.
import './sar-primary-focus-stability-runtime.mjs';
...
const runtime={
  ...
  visualRelease:'R260',
  patchRelease:'R260.3',
  livenessRelease:'R260.7',
  navigationRelease:'R260.8',
  revision:'R260-8-DETERMINISTIC-SAR-PRIMARY-FOCUS-STABLE-RESPONSIVE-WORKSTATION',
  ...
  refreshPolicy:'CANON_CUBE_EVENT_REBUILD_PLUS_R260_VISUAL_FIELD_REBUILD_PLUS_NON_STARVABLE_BOOTSTRAP_PLUS_NON_STARVABLE_REGIONAL_COG_WATCHDOG_PLUS_DETERMINISTIC_EXPLICIT_SAR_FOCUS_SETTLE_PLUS_SAME_KEY_REGIONAL_READ_REUSE_PLUS_CAMERA_SETTLED_PROGRESSIVE_SOURCE_DETAIL_PLUS_GLOBAL_FABRIC_PLUS_Z12_DEM_STREAM_PLUS_TARGET_BOUND_PROVIDER_WATCH_5_MIN',
