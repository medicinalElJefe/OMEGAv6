...
const runtime={
  ...
  experience:{defaultMode:'EXPLORE',layout:'FULL_BLEED_EARTH_WITH_ON_DEMAND_MISSION_EVIDENCE_ANALYSIS_DRAWERS',modes:['EXPLORE','ANALYZE','PROOF'],cleanView:true,keyboard:['M_MISSION','E_EVIDENCE','A_ANALYSIS','F_CLEAN','ESC_CLOSE'],globalFabricVisual:'SOFT_CONTINUOUS_SOURCE_SUPPORT_FIELD_NOT_GRID'},
