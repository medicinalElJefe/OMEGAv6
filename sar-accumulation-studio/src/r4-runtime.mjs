...
const runtime={
  ...
  revision:'R260-7-REGIONAL-COG-NONSTARVABLE-STABLE-RESPONSIVE-WORKSTATION',
  ...
  refreshPolicy:'CANON_CUBE_EVENT_REBUILD_PLUS_R260_VISUAL_FIELD_REBUILD_PLUS_NON_STARVABLE_BOOTSTRAP_PLUS_NON_STARVABLE_REGIONAL_COG_WATCHDOG_PLUS_SAME_KEY_REGIONAL_READ_REUSE_PLUS_CAMERA_SETTLED_PROGRESSIVE_SOURCE_DETAIL_PLUS_GLOBAL_FABRIC_PLUS_Z12_DEM_STREAM_PLUS_TARGET_BOUND_PROVIDER_WATCH_5_MIN',
