...
const runtime={
  ...
  featureRelease:'R258',
  patchRelease:'R258.6',
  revision:'R258.6-FULL-CANON-UNIFIED-COHERENCE-COMPACT-DATA-PLANE',
  ...
  refreshPolicy:'NON_STARVABLE_BOOTSTRAP_PLUS_CAMERA_SETTLED_PROGRESSIVE_SOURCE_DETAIL_PLUS_GLOBAL_FABRIC_PLUS_Z12_DEM_STREAM_PLUS_TARGET_BOUND_PROVIDER_WATCH_5_MIN',
