...
const runtime={
  ...
  featureRelease:'R258',
  patchRelease:'R258.7',
  revision:'R258.7-FULL-CANON-UNIFIED-COHERENCE-REGIONAL-MEASURED-READINESS',
  ...
  refreshPolicy:'NON_STARVABLE_BOOTSTRAP_PLUS_SAME_KEY_REGIONAL_READ_REUSE_PLUS_CAMERA_SETTLED_PROGRESSIVE_SOURCE_DETAIL_PLUS_GLOBAL_FABRIC_PLUS_Z12_DEM_STREAM_PLUS_TARGET_BOUND_PROVIDER_WATCH_5_MIN',
