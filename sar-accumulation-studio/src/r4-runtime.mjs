...
const runtime={
  release:'R4-R257',
  featureRelease:'R258',
  revision:'R258-DATA-PLANE-CALCULUS',
...
function polish(){
  ...
  const meta=document.querySelector('meta[name="description"]');if(meta)meta.content='OMEGA SAR R4 R258 feature release — one authoritative SAR image plane with calibrated Sentinel-1 detail, blade georegistration, measured spatial calculus, bounded temporal intensity-change analysis, DEM context and reserved non-overlapping workstation panels.';
