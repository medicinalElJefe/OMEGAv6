export const R260_DOMAIN_REGISTRY=Object.freeze({
  ...
  GNSS:Object.freeze({label:'EarthScope / NSF NGF GNSS geodesy',family:'GEODESY',status:'LIVE_SOURCE_PROVEN',observables:['station_support','position_time_series','velocity_vector','derived_velocity_gradient'],units:['WGS84','source-declared position units','mm/yr','microstrain/yr derived'],visualRole:'SOURCE_PROVEN_VECTOR_ANCHORS_AND_DERIVED_GRADIENT',truth:'Measured authority requires fixed EarthScope/NGF source proof. Velocity is tied to its declared reference frame; the derived local velocity gradient is not borehole strain or stress.'}),
  STRAIN:Object.freeze({label:'Borehole strain',family:'GEODESY',status:'BOUNDED_TRANSPORT_ADAPTER_PENDING',observables:['strain_time_series'],units:['source declared'],visualRole:'FIELD_OR_TIME_SERIES_WHEN_PROVEN',truth:'The fixed NGF transport family exists, but measured Canon authority remains disabled until a station-selection adapter proves and parses a source product.'}),
  SEISMIC:Object.freeze({label:'Station seismic',family:'SEISMOLOGY',status:'ADAPTER_PENDING',observables:['waveform','station_state'],units:['source declared'],visualRole:'WAVEFORM_OR_EVENT_FIELD_WHEN_PROVEN',truth:'Schema is available; continuous waveform streaming must use an appropriate source such as EarthScope services/SeedLink rather than browser polling.'}),
  TILT:Object.freeze({label:'Tiltmeter',family:'GEODESY',status:'BOUNDED_TRANSPORT_ADAPTER_PENDING',observables:['tilt','rotation_time_series'],units:['source declared'],visualRole:'ORIENTATION_FIELD_WHEN_PROVEN',truth:'Fixed NGF transport is available; measured authority still requires source-proven station discovery and numeric parsing.'}),
  PORE_PRESSURE:Object.freeze({label:'Pore pressure',family:'HYDRO_GEOMECHANICS',status:'BOUNDED_TRANSPORT_ADAPTER_PENDING',observables:['subsurface_fluid_pressure'],units:['source declared'],visualRole:'SCALAR_FIELD_WHEN_PROVEN',truth:'Fixed NGF transport is available; measured authority still requires source-proven station discovery and numeric parsing.'}),
  ENVIRONMENT:Object.freeze({label:'Environmental station data',family:'ENVIRONMENT',status:'BOUNDED_TRANSPORT_ADAPTER_PENDING',observables:['temperature','atmospheric_pressure','rainfall','pore_temperature'],units:['source declared'],visualRole:'CONTEXT_FIELD_WHEN_PROVEN',truth:'Fixed NGF transport is available; measured authority still requires source-proven station discovery and numeric parsing.'}),
...
export const R260_ENGLISH_TRANSLATION=Object.freeze({
  ...
  geodesy:'GNSS vectors are independent measured Earth-motion evidence in a declared reference frame. They can constrain interpretation and support derived velocity gradients, but they do not become SAR phase, LOS displacement, or synthetic detail.'
});
...
export const R260_DOMAIN_BOUNDARY='This registry translates charted and documented Earth-data families into one software contract. R261 activates GNSS only through fixed source-proven EarthScope/NGF transport. It does not copy another system, create physical laws, or promote unparsed/pending adapters into live measurement.';