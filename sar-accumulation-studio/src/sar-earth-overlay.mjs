...
function drawTriangle(image,s0,s1,s2,d0,d1,d2){
  ...
  ctx.globalAlpha=.94;ctx.imageSmoothingEnabled=true;ctx.transform(t.a,t.b,t.c,t.d,t.e,t.f);ctx.drawImage(image,0,0);ctx.restore();return true;
}
function drawCell(image,s00,s10,s01,s11,d00,d10,d01,d11){
  const a=drawTriangle(image,s00,s10,s11,d00,d10,d11);
  const b=drawTriangle(image,s00,s11,s01,d00,d11,d01);
  return a||b;
}
function draw(){
  ...
  for(let gy=0;gy<n;gy++)for(let gx=0;gx<n;gx++){
    ...
    const s00=[q00.pixel-x0,q00.line-y0],s10=[q10.pixel-x0,q10.line-y0],s01=[q01.pixel-x0,q01.line-y0],s11=[q11.pixel-x0,q11.line-y0];
    if(drawCell(image,s00,s10,s01,s11,d00,d10,d01,d11))cells++;
  }
  if(!cells)return;
